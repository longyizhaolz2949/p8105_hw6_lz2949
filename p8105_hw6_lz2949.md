...
prediction error. This is probably because the first model only uses 1
factor as the predictor and the second and third use more complex model
than the first one which will explain more variances and thus fit data
in a better way.
